...
%-----LOAD-ENVIRONMENT----------------------------------------------------%
    ...
    elseif eflag==2
        load(strcat(['../test_output_environments/env_bounded_sx=' num2str(sx) '_sy=' num2str(sy) '_b=' num2str(b) '.mat']))
    elseif eflag==3
...
%-----CALCULATE OUTPUTS-----%
    ...
    for i = 1:nbins
        ...
        mortality_cost(i) = died_in_nav/size(off_dist,1);
    end
    ...
    for i = 1:nbins
        ...
        kincomp2_cost(i) = mean(kincost2_i);
        clear off_dist
    end
