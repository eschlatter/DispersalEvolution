function [] = IBM_dispersal_2D_wK(gflag,eflag,sx,sy,nbins_env,nbins,nmax,G,b,p,del,K)
% written by Allison K. Shaw (ashaw@umn.edu)
% updated: June 2018
%
% modified version of IBM_dispersal_2D to have per-patch carrying
% capacity
%
...
%   K = number of adults supported per patch
% 
...
while g<G && size(pop,1)>0 % loop over generations (only while population not extinct)
    ...
    if eflag==1
        save(strcat(['IBM_unbounded_sx=' num2str(sx) '_sy=' num2str(sy) '_nbins=' num2str(nbins) '_nmax=' num2str(nmax) '_del=' num2str(del) '_b=' num2str(b) '_p=' num2str(p) '_K=' num2str(K) '.mat']))
    elseif eflag==2
        save(strcat(['IBM_bounded_sx=' num2str(sx) '_sy=' num2str(sy) '_nbins=' num2str(nbins) '_nmax=' num2str(nmax) '_del=' num2str(del) '_b=' num2str(b) '_p=' num2str(p) '_K=' num2str(K) '.mat']))
    elseif eflag==3
        save(strcat(['IBM_reef_nbins=' num2str(nbins) '_nmax=' num2str(nmax) '_bmin=' num2str(bmin) '_bmax=' num2str(bmax) '_del=' num2str(del) '_p=' num2str(p) '_K=' num2str(K) '.mat']))
    elseif eflag==4
        save(strcat(['IBM_bounded_het_sx=' num2str(sx) '_sy=' num2str(sy) '_nbins=' num2str(nbins_env) '_nmax=' num2str(nmax) '_bmin=' num2str(bmin) '_bmax=' num2str(bmax) '_del=' num2str(del) '_p=' num2str(p) '_K=' num2str(K) '.mat']))
    end

    if mod(g,5000)==0
        % save output as mat file
        if eflag==3
            save(strcat(['IBM_reef_nbins=' num2str(nbins) '_nmax=' num2str(nmax) '_bmin=' num2str(bmin) '_bmax=' num2str(bmax) '_del=' num2str(del) '_p=' num2str(p) '_K=' num2str(K) '_g=' num2str(g) '.mat']))
        end
    end
end % generation loop
...
%-----PLOT-RESULTS--------------------------------------------------------%
    ...
    % save figure
    if eflag==1
        saveas(2,strcat(['IBMfig_unbounded_sx=' num2str(sx) '_sy=' num2str(sy) '_nbins=' num2str(nbins) '_nmax=' num2str(nmax) '_del=' num2str(del) '_b=' num2str(b) '_p=' num2str(p) '_K=' num2str(K) '.jpg']))
    elseif eflag==2
        saveas(2,strcat(['IBMfig_bounded_sx=' num2str(sx) '_sy=' num2str(sy) '_nbins=' num2str(nbins) '_nmax=' num2str(nmax) '_del=' num2str(del) '_b=' num2str(b) '_p=' num2str(p) '_K=' num2str(K) '.jpg']))
    elseif eflag==3
        saveas(2,strcat(['IBMfig_reef_nbins=' num2str(nbins) '_nmax=' num2str(nmax) '_bmin=' num2str(bmin) '_bmax=' num2str(bmax) '_del=' num2str(del) '_p=' num2str(p) '_K=' num2str(K) '.jpg']))
    elseif eflag==4
        saveas(2,strcat(['IBMfig_bounded_het_sx=' num2str(sx) '_sy=' num2str(sy) '_nbins=' num2str(nbins_env) '_nmax=' num2str(nmax) '_bmin=' num2str(bmin) '_bmax=' num2str(bmax) '_del=' num2str(del) '_p=' num2str(p) '_K=' num2str(K) '.jpg']))
    end
%-----PLOT-RESULTS--------------------------------------------------------%
