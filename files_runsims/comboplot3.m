function comboplot3(dtime_avg,dtime_std,nmax,rep,endmin, endmax)
...
fig_position(3) = 1.5*fig_position(3); %width
fig_position(4) = 1.5*fig_position(4); %height
set(gcf,'Position',fig_position);

%save it
exportgraphics(t,strcat('C:\Users\eschlatter\Dropbox\DispersalEvolution\output_simulations\all_20221103\comboplot3_nmax=',num2str(nmax),...
