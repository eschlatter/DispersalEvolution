function [] = create_env_heterogeneous(sx,sy,nbins_env,nmax,bmin,bmax)
% written by Allison K. Shaw (ashaw@umn.edu)
% updated: November 2015
%
% USAGE: [] = create_env_heterogeneous(sx,sy,nbins_env,nmax,bmin,bmax)
%
...
save(strcat(['env_bounded_het_sx=' num2str(sx) '_sy=' num2str(sy) '_nbins=' num2str(nbins_env) '_nmax=' num2str(nmax) '_bmin=' num2str(bmin) '_bmax=' num2str(bmax) '.mat']))
...
grid on
saveas(1,strcat(['env_bounded_het_sx=' num2str(sx) '_sy=' num2str(sy) '_bmin=' num2str(bmin) '_bmax=' num2str(bmax) '.jpg']))
clear Etmp
